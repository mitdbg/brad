...
db_instance="aurora-2-instance-1"
...
cond run 08-load-scaling/aurora_cpu_6:r6g_large
...
>&2 echo "Warming up..."
python3 runner.py --cstr_var AURORA_CSTR --run_warmup
cond run 08-load-scaling/aurora_cpu_6:r6g_xlarge
...
>&2 echo "Warming up..."
python3 runner.py --cstr_var AURORA_CSTR --run_warmup
cond run 08-load-scaling/aurora_cpu_6:r6g_2xlarge
