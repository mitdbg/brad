...
QUERY_1_MERGED = """
WITH lineitem_merged AS (
  SELECT * FROM lineitem_1
  UNION ALL
  SELECT * FROM lineitem_2
)
SELECT
  l_returnflag,
  l_linestatus,
...
def main():
    ...
    run_merged = args.exp == "run_merged"
