...
class ThreadPool {
 public:
  ...
  // `run_on_start` right after they start.
  ThreadPool(size_t num_threads,
             std::function<void()> run_on_start = std::function<void()>(),
             std::function<void()> run_on_finish = std::function<void()>());
 ...
 private:
  ...
  std::function<void()> run_on_start_, run_on_finish_;
};
