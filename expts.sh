...
# python workloads/IMDB_extended/run_transactions.py --tidb --output-dir tidb_expts/txn1 --num-clients $1 --run-for-s $duration
# echo "Running txns with $2 clients"
# python workloads/IMDB_extended/run_transactions.py --tidb --output-dir tidb_expts/txn10 --num-clients $2 --run-for-s $duration
