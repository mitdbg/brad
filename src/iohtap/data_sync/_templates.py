from iohtap.config.strings import AURORA_EXTRACT_PROGRESS_TABLE_NAME
...
GET_MAX_EXTRACT_TEMPLATE = "SELECT MAX(iohtap_seq) FROM {table_name}"
...
DELETE_FROM_SHADOW_STAGING = "DELETE FROM {shadow_staging_table} WHERE iohtap_seq >= {lower_bound} AND iohtap_seq <= {upper_bound}"
