...
class RuleBased(Router):
    def __init__(self, blueprint_mgr: BlueprintManager, monitor: Monitor, deterministic: bool = True):
        self._blueprint_mgr = blueprint_mgr
        # deterministic routing guarantees the same decision for the same query and should be used online
        # non-determinism will be used for offline training data exploration
    ...
    def engine_for(self, query: QueryRep) -> Engine:
        ...
        if len(locations) == 0:
            ...
            # Todo: implement the rules for routing queries
