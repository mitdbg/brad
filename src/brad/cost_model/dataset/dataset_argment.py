...
# Number 2
# AUG_DIST_AURORA_100 = {2: 0.5, 20: 2, 50: 5, 100: 12, 500: 30}
# AUG_DIST_REDSHIFT_100 = {3: 0.333, 10: 1, 20: 4, 50: 10, 100: 20, 500: 40}

# Number 3 (best so far)
# AUG_DIST_AURORA_100 = {2: 2, 20: 6, 50: 12, 100: 28, 500: 80}
# AUG_DIST_REDSHIFT_100 = {3: 1, 10: 4, 20: 16, 50: 40, 100: 80, 500: 160}

# Not used
# AUG_DIST_AURORA_100 = {3: 2, 25: 2, 50: 3, 100: 1, 500: 15}
# AUG_DIST_REDSHIFT_100 = {20: 2, 500: 1}

# Number 4
# AUG_DIST_AURORA_100 = {2: 3, 20: 6, 50: 12, 100: 28, 500: 80}
# AUG_DIST_REDSHIFT_100 = {3: 3, 10: 4, 20: 16, 50: 40, 100: 80, 500: 160}

# Number 5
AUG_DIST_AURORA_100 = {2: 1, 20: 6, 50: 15, 100: 30, 500: 90}
AUG_DIST_REDSHIFT_100 = {3: 1, 10: 4, 20: 18, 50: 50, 100: 90, 500: 170}
...
def augment_dataset(source, target, custom_dist_name: Optional[str] = None):
    ...
    for i, q in enumerate(runs["parsed_queries"]):
        ...
        for upper_limit, adjustment in dist.items():
            if runtime <= upper_limit:
                if adjustment >= 1 or (prng.random() < adjustment):
                    dup_times = max(adjustment, 1)
